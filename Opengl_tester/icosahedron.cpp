...
// Corrected Icosahedron vertices based on three mutually orthogonal golden rectangles
...
void display() {
    ...
    for (int i = 0; i < 20; i++) {
        ...
        for (int x = 0; x < 3; x++) {
            glColor3f(0.5 + (float)x / 3.0, 0.2 + (1.0 - (float)x / 3.0) * 0.8, 0.5 + (float)(i % 3) / 3.0);
